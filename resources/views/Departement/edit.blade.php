...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit Departement
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('departements.update',$departement->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="departementname" type="text" class="form-control @error('departementname') is-invalid @enderror" name="departementname" value="{{ old('departementname',$departement->name) }}" required autocomplete="non" autofocus>
